...
const transcript = [
    {
        speaker: "You",
        tone: "primary",
        line: "Let's lock the launch date before we scope the rest.",
    },
    {
        speaker: "Speaker 2",
        tone: "muted",
        line: "Works for me. I'll own the migration checklist.",
    },
    {
        speaker: "Speaker 3",
        tone: "muted",
        line: "I can have the pricing page ready by Thursday.",
    },
    {
        speaker: "You",
        tone: "primary",
        line: "Decision: ship on the 24th, freeze scope Friday.",
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="space-y-1 border-b border-border px-5 py-4 font-mono text-2xs leading-relaxed text-muted-foreground">
                ...
                <p>
                    <span className="text-primary">attendees</span>: You, Speaker 2,
                    Speaker 3
                </p>
                <p>
                    <span className="text-primary">duration</span>: 28m ·{" "}
                    <span className="text-primary">model</span>: whisper-large-v3
                </p>
                <p>
            ...
            <div className="space-y-3.5 px-5 py-5">
                {transcript.map((row, index) => (
                    <div key={index} className="flex gap-3">
                        ...
                        <p className="text-ms-13 leading-relaxed text-foreground/90">
                            {row.line}
                        </p>
                    </div>
                ))}
