  ...
  return (
    <nav className="mt-16 grid gap-4 border-t border-border pt-8 sm:grid-cols-2">
      {prev ? (
        <Link
          href={prev.href}
          className="group flex flex-col gap-1 rounded-xl border border-border bg-card p-4 text-left shadow-sm transition-shadow hover:shadow-lift focus-ring"
        >
      ...
      {next && (
        <Link
          href={next.href}
          className="group flex flex-col gap-1 rounded-xl border border-border bg-card p-4 text-right shadow-sm transition-shadow hover:shadow-lift focus-ring sm:items-end"
        >
          <span className="flex items-center gap-1.5 font-mono text-2xs uppercase tracking-[0.14em] text-muted-foreground">
            Next
