    ...
    return (
        <div
            className={cn(
                ...
                "[&_li>strong]:text-foreground [&_li]:pl-1.5",
...
export function Steps({ children }: { children: React.ReactNode }) {
    return (
        <ol className="my-6 flex flex-col gap-6 border-l border-border pl-8">
            {children}
        </ol>
    );
}
...
export function Field({
    ...
    return (
        <div className="grid gap-1 px-5 py-4 sm:grid-cols-[12rem_1fr] sm:gap-6">
            ...
            <dd className="text-ms-15 leading-relaxed text-muted-foreground">
                {children}
            </dd>
        </div>
    );
...
export function LinkCard({
    ...
    return (
        <Link
            ...
            className="focus-ring group flex flex-col gap-2 rounded-xl border border-border bg-card p-5 shadow-sm transition-shadow hover:shadow-lift"
        >
            ...
            <span className="text-ms-13 leading-relaxed text-muted-foreground">
                {children}
            </span>
        </Link>
    );
