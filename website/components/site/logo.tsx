  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <feDropShadow dx="0" dy="32" stdDeviation="34" floodColor="#000000" floodOpacity="0.46" />
          <feDropShadow dx="0" dy="10" stdDeviation="16" floodColor="#303034" floodOpacity="0.22" />
        </filter>
        <clipPath id="folio-orb-clip">
          <circle cx="512" cy="500" r="274" />
        </clipPath>
      </defs>
      <rect x="80" y="80" width="864" height="864" rx="212" fill="url(#folio-tile)" />
      <rect
        x="81.5"
        y="81.5"
        width="861"
