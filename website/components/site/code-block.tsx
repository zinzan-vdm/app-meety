...
export function CopyButton({ value, className }: { value: string; className?: string }) {
    ...
    return (
        <button
            ...
            className={cn(
                "focus-ring inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground",
                className
            )}
        >
            {copied ? (
