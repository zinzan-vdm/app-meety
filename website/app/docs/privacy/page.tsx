        ...
        <>
            ...
            <Prose>
                ...
                <ul>
                    <li>
                        ...
                        This is not a setting you trust us to honor. It is enforced in CI
                        by a dedicated <code>no-telemetry</code> job that runs on every
            ...
            <Prose>
                <p>
                    ...
                    to make. {siteConfig.name} makes only these network calls, and each
                    one can be blocked.
                </p>
                <ul>
                    <li>
                        <strong>A one-time model-weights download.</strong> On first local
                        transcription or diarization, {siteConfig.name} downloads the
                        model weights once. This is a few hundred megabytes, pulled from
                        Hugging Face and from the <code>sherpa-onnx</code> GitHub
                        releases. After that, the local path needs no network at all.
                    </li>
                    <li>
                        <strong>The opt-in cloud-AI path.</strong> The OpenAI Whisper API
                        is an opt-in fallback for faster cloud transcription on long
                        meetings. It needs an OpenAI key. It is never the default, and you
                        choose when to use it.
                    </li>
                    <li>
                        <strong>The opt-in webhook path.</strong> If you wire up a
                        webhook, {siteConfig.name} can call it. This is opt-in and off
                        until you set it up.
                    </li>
                </ul>
                <p>
            ...
            <Prose>
                <p>
                    ...
                    <strong>Privacy</strong>. Privacy Mode physically blocks every
                    outbound HTTP call except <code>localhost</code>. There is nothing
                    left to forget about and no path to leak through.
                </p>
                <p>
            ...
            <Prose>
                ...
                <p>
                    Retention is therefore in your hands. A note exists for exactly as
                    long as the file exists. When you delete the file, the note is gone.
                    There is no separate copy to clear and no server-side record to
                    request the deletion of. The on-disk file is the canonical artifact,
                    and the derived index is always rebuildable from the files.
                </p>
                <p>
                    For the full account of what {siteConfig.name} stores and what it
                    never touches, read the{" "}
            ...
            <Prose>
                <p>
                    {siteConfig.name} gives you a recording tool. Using it lawfully is
                    your responsibility, and the law here is not uniform.
                </p>
            </Prose>
            ...
            <Prose>
                <p>
                    ...
                    privacy, including the full list of what stays on your machine and
                    what the opt-in paths do, read the{" "}
                    <a href={siteConfig.links.privacy} target="_blank" rel="noreferrer">
