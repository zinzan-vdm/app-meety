    ...
    <>
      ...
      <Prose>
        ...
        <p>
          ...
          <strong>microphone</strong> access so {siteConfig.name} can record your
          voice, and for <strong>screen recording</strong> access, which is
        ...
        <p>
          Finally, choose a <strong>vault path</strong>. This is the folder where{" "}
      ...
      <Steps>
        ...
        <Step n={2} title="System audio and microphone are recorded separately">
          <p>
            ...
            <code>cpal</code> captures your microphone. The two are recorded as
            distinct streams rather than one mixed track. <code>rubato</code>{" "}
            handles resampling and <code>hound</code> writes the WAV files.
          </p>
        </Step>
        ...
        <Step n={4} title="The note is written">
          <p>
            ...
            <code>You</code>, and the other voices are clustered into{" "}
