...
export default function InstallationPage() {
    return (
        <>
            ...
            <Prose>
                <p>
                    Once installed, <code>{siteConfig.install.upgradeCommand}</code>{" "}
                    tracks new releases and keeps your copy current.
                </p>
            </Prose>
            ...
            <Prose>
                ...
                <p>
                    ...
                    so they open without a Gatekeeper prompt. Intel builds are not
                    published yet. On Intel, build from source.
                </p>
            </Prose>
            ...
            <Steps>
                <Step n={1} title="Install the prerequisites">
                    <Prose>
                        ...
                        <ul>
                            <li>
                                <strong>Rust 1.88</strong> via <code>rustup</code>, pinned
                                in <code>rust-toolchain.toml</code>.
                            </li>
                            <li>
                                <strong>Bun 1.3+</strong>, the only JavaScript package
                                manager and runtime this repository uses.
                            </li>
                            <li>
                ...
                <Step n={2} title="Clone and set up the repository">
                    <Prose>
                        <p>
                            Clone the repo, install dependencies with Bun, and register
                ...
                <Step n={3} title="Run the desktop app">
                    <Prose>
                        <p>
                            Start the app in development. The first launch compiles the
                            Rust workspace in about 30 seconds on a warm cache.
                        </p>
                    </Prose>
